...
import { FiTrash, FiList,FiCheckSquare, FiTag,FiType,FiCalendar } from 'react-icons/fi';
import { colorsList } from "../../../utils";
import Modal from "../../Modal/Modal";
import CustomInputPanel from "../../CustomInput";
import { ICard, ILabel, ITask } from "../../../Pages/BoardVariables";
import "./CardInfo.css";
        ...
        <div className="cardinfo-box">
          ...
          <div className="cardinfo-box-labels">
            {cardValues.labels?.map((item, index) => (
              <Badge key={index} item={item} removeLabel={removeLabel} />
            ))}
          </div>
          <ul>
